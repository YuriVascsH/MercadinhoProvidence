...
//         f1.setJobTitle(JobTitle.GERENTE);
...
//         f2.setJobTitle(JobTitle.OPERADOR);
...
//         assertEquals(JobTitle.GERENTE, resultado.getFirst().getJobTitle());
...
//         assertEquals(JobTitle.OPERADOR, resultado.get(1).getJobTitle());
//     }
