...
import br.com.mercadinhoprovidence.balance.Balance;
...
public class TelaVenda extends VBox {
    ...
    public TelaVenda(Stage primaryStage, Consumer<Funcionario> onReturnToInitialScreen,
        ...
        this.balance = new BalanceRamuza(balanceConfig);
                ...
                if (quantidadeParaAddComAutorizacao > 0) {
                    if (itemExistente != null) {
                        itemExistente.setQuantidadeOuPeso(
                                itemExistente.getQuantidadeOuPeso() + quantidadeParaAddComAutorizacao);
                    } else {
    ...
    private Double solicitarAutorizacaoEQuantidade(Produto produto, Double estoqueDisponivel,
