...
// import br.com.mercadinhoprovidence.model.enums.Forma; // Importação correta do Enum
...
//         public VendaDao(ItemVendaDao itemVendaDao, ProdutoDao produtoDao) {
...
//                     rs.getDouble("valorSubtotal"),
//                     rs.getDouble("valorDesconto"),
//                     rs.getDouble("valorTotal"),
//                     rs.getInt("idFuncionario"),
//                     rs.getDouble("valorTotalManual"),
...
//                             INSERT INTO VENDAS (
//                                 dataHora, valorSubtotal, valorDesconto, valorTotal, idFuncionario, 
//                                 valorTotalManual, troco, valorPago, forma
//                             ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
//                         """;
...
//                     // ESTE MÉTODO DEVE SER IMPLEMENTADO NO SEU ProdutoDao
//                     produtoDao.atualizarEstoqueComConexao(item, conn);
//                 }
