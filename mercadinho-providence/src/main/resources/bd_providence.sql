...
INSERT INTO Operador (idFuncionario, ultima_venda) VALUES (1001, '2025-10-20 10:30:00');
...
INSERT INTO ITENS_VENDA (idVenda, idProduto, quantidade_ou_peso, preco_unitario_venda, total_item)
VALUES (1, 1, 2.00, 25.00, 50.00);
INSERT INTO ITENS_VENDA (idVenda, idProduto, quantidade_ou_peso, preco_unitario_venda, total_item)
VALUES (1, 3, 0.50, 6.99, 3.495);
UPDATE VENDAS SET valor_subtotal = (50.00 + 3.495), valor_desconto = 1.00, valor_total = (50.00 + 3.495 - 1.00) WHERE idVenda = 1;
INSERT INTO ITENS_VENDA (idVenda, idProduto, quantidade_ou_peso, preco_unitario_venda, total_item)
VALUES (2, 2, 3.00, 14.99, 44.97);
INSERT INTO ITENS_VENDA (idVenda, idProduto, quantidade_ou_peso, preco_unitario_venda, total_item)
VALUES (2, 4, 1.00, 3.50, 3.50);
UPDATE VENDAS SET valor_subtotal = (44.97 + 3.50), valor_desconto = 0.00, valor_total = (44.97 + 3.50) WHERE idVenda = 2;
INSERT INTO PAGAMENTOS (troco, valor_pago, forma, idVenda)
